 ...
 */
MapTo('tali/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('tali/components/separator')(SeparatorV1Component);

MapTo('tali/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('tali/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('tali/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('tali/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('tali/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('tali/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('tali/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('tali/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('tali/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('tali/components/accordion')(AccordionV1Component);
MapTo('tali/components/tabs')(TabsV1Component);
...
LazyMapTo('tali/components/teaser')(TeaserV1Component);
...
LazyMapTo('tali/components/carousel')(CarouselV1Component);
...
LazyMapTo('tali/components/text')(LazyTextModule, TextEditConfig);